...
Graphic parameters:
    plots_side (int) - Number of PSF to plots on a side
...
# Data parameters
dir_psf = '/g2/scratch/skterry/work/AIROPA/sean_tests/new-POOR-run/fit/variable'
data_psf = 'c0271_psf_grid.fits'
data_grid = 'c0271_grid_pos.fits'
...
# Show plots
i_ax = 0
fig, axs = plt.subplots(plots_side, plots_side, figsize=(9, 9))
...
# End program
plt.savefig('psf_grid.png', dpi=300)
plt.savefig('psf_grid.pdf')
plt.show()
